...
class CrackUnetModel(nn.Module):
    def __init__(self, encoder_name: str = "resnet34", encoder_weights: str = "imagenet", in_channels: int = 3):
        """Initializes the Unet crack segmentation model using segmentation-models-pytorch.
        
        Args:
            encoder_name: Backbone encoder network (e.g., 'resnet18', 'resnet34', 'efficientnet-b0').
